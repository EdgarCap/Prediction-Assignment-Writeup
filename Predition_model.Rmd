...
## 9. Improve the model reducing variable that have hight correlation
...
```
##10. Subset the training data and leave only the variable "accel_belt_z" the others variables will be omit in the model
